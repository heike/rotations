...
f(\bm E_i|\kappa)=\frac{4\pi}{3-\tr(E_i)}C\left(\cos^{-1}\left\{\frac{1}{2}[\tr(\bm E_i)-1]\right\}|\kappa\right)
\end{equation}
...
##        [,1]    [,2]    [,3]
## [1,] 0.4832 -0.4136 -0.7716
## [2,] 0.8499  0.4330  0.3002
## [3,] 0.2100 -0.8009  0.5608
\end{verbatim}
\end{kframe}
\end{knitrout}
