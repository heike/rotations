...
\]
Now let $\bm V=2\sin(r)\Phi(\bm u)$ then by the definition of $\Phi(\cdot)$, $u_1=-V_{2,3}/2\sin(r)$, $u_2=V_{1,3}/2\sin(r)$ and $u_3=-V_{1,2}/2\sin(r)$.  The function \code{eaxis} will perform this calculation.
