...
#' Method for creating a rotation using the angle axis representation
#'
#' A three dimensional rotation can be constructed from a three dimensional (orthonormal) vector, giving the direction of the fix axis, 
#' and an angle that describes the amount of rotation around the fix axis.
#' This is called the angle-axis representation of a rotation.
#' The Rodrigues formula gives us a transformation from angle-axis into a 3 by 3 real-valued matrix R, as
#' XXX formula
#'
#' @export
#' @param U three-dimensional vector describing the fix axis of the rotation
#' @param theta angle between -pi and pi
#' @return rotation in SO3 class representation
